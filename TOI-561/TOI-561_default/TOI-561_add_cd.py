...
starname = 'TOI-561_add_cd'
nplanets = 4
fitting_basis = 'per tc secosw sesinw k'
bjd0 = 0.
planet_letters = {1: 'b', 2: 'c', 3: 'd', 4: 'add_cd'}
...
params['per4'] = radvel.Parameter(value = 13.252)
params['tc4'] = radvel.Parameter(value = 2458520.5892850896)
params['e4'] = radvel.Parameter(value = 0.022727867673090502, vary=True)
params['w4'] = radvel.Parameter(value = 0)
params['k4'] = radvel.Parameter(value = 1.3666819460758033)
...
priors += [radvel.prior.EccentricityPrior(4, upperlims=[0.99, 0.1475592312925229, 0.98, 0.14751869961916886])]
for telescope in telescopes:
