...
starname = 'TOI-1246_add_bc'
nplanets = 6
fitting_basis = 'per tc secosw sesinw k'
bjd0 = 0.
planet_letters = {1: 'b', 2: 'c', 3: 'd', 4: 'e', 5: 'f', 6: 'add_bc'}
...
params['per6'] = radvel.Parameter(value = 5.043)
params['tc6'] = radvel.Parameter(value = 2458324.155810802)
params['e6'] = radvel.Parameter(value = 0.025189924806160804, vary=True)
params['w6'] = radvel.Parameter(value = 0)
params['k6'] = radvel.Parameter(value = 5.238604567620204)
...
priors += [radvel.prior.EccentricityPrior(6, upperlims=[0.11038724736857919, 0.99, 0.6043697301744824, 0.8290391709080689, 0.98, 0.11030431848320954])]
for telescope in telescopes:
