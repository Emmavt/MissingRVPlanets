...
starname = 'TOI-1246_add_de'
nplanets = 6
fitting_basis = 'per tc secosw sesinw k'
bjd0 = 0.
planet_letters = {1: 'b', 2: 'c', 3: 'd', 4: 'e', 5: 'f', 6: 'add_de'}
...
params['per6'] = radvel.Parameter(value = 26.601)
params['tc6'] = radvel.Parameter(value = 2459418.411813524)
params['e6'] = radvel.Parameter(value = 0.0661595443932215, vary=True)
params['w6'] = radvel.Parameter(value = 0)
params['k6'] = radvel.Parameter(value = 3.009395627280962)
...
priors += [radvel.prior.EccentricityPrior(6, upperlims=[0.23286775594201736, 0.99, 0.26665268827527644, 0.8290391709080689, 0.98, 0.26662165961140816])]
for telescope in telescopes:
