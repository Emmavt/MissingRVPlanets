...
starname = 'TOI-1246_add_ef'
nplanets = 6
fitting_basis = 'per tc secosw sesinw k'
bjd0 = 0.
planet_letters = {1: 'b', 2: 'c', 3: 'd', 4: 'e', 5: 'f', 6: 'add_ef'}
telescopes = np.unique(tel)

params = radvel.Parameters(6, basis='per tc e w k', planet_letters=planet_letters)
...
params['e4'] = radvel.Parameter(value = 0, vary=True)
...
params['e5'] = radvel.Parameter(value = 0, vary=True)
params['w5'] = radvel.Parameter(value = 0)
params['k5'] = radvel.Parameter(value = 3)

params['per6'] = radvel.Parameter(value = 59.64)
params['tc6'] = radvel.Parameter(value = 2458574.6407554434)
params['e6'] = radvel.Parameter(value = 0.024776047502551864, vary=True)
params['w6'] = radvel.Parameter(value = 0)
params['k6'] = radvel.Parameter(value = 2.2993198842607705)
...
priors = [radvel.prior.PositiveKPrior(6)]
...
priors += [radvel.prior.EccentricityPrior(6, upperlims=[0.23286775594201736, 0.99, 0.6043697301744824, 0.3524240050717071, 0.98, 0.3524154880784529])]
for telescope in telescopes:
